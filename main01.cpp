...
void test1()
{
	try
	{
		Form *form = new Form("55", 140, 150);
		Bureaucrat *bureaucrat = new Bureaucrat("John", 135);
		std::cout << form;
		try
		{
